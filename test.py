...
while True:
    ...
    print(heading)
    print()
    chosen = user_choice(' Please choose Rock, paper, scissors or 000 to end : ', " Please enter rock, paper or scissors ", ['rock', 'paper', 'scissors', '000'])
    print()
    ...
    if chosen != "000":
        ...
        if computer == "rock" and chosen == "scissors" or computer== "scissors" and chosen == "paper" or  computer == "paper" and chosen == "rock":
            statement = "❌❌You lost❌❌"
            loss += 1
