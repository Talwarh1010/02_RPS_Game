...
while not (response := input("How many rounds do you want to play? ")).isdigit() == True or int(response) <= 0:
    if response == "":
        break
    print("Please press <enter> or enter an integer more than 0")
    
if response == "":
    final_round = ""
else:
    final_round = int(response)
...
while True:
        ...
        elif chosen == "000" and round_num == 1:
            break
